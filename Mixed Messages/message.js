...
const verb = ['serenade ', ' tickle', 'humiliate ', 'hunt ', 'lick ', 'aggrivate ', 'befriend ', 'belittle ', 'laugh at ', 'trick ', 'consume ', 'steal ', 'tempt ', 'explode ', 'kick ', 'measure ', 'bathe ', 'seduce ', 'slap '];
...
const end = ['at midnight.', 'in the evening.', 'from across the room.', 'at first light.', 'as soon as possible.', 'whilst it sleeps.', 'without warning.', 'on a full moon.', 'when alone.', 'with friends.', 'after alcohol.', 'at dawn.', 'at dusk.', 'without backup.', 'whilst driving.'];
